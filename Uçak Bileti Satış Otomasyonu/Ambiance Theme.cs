...
class Ambiance_Button_2 : Control
{
    ...
    public Ambiance_Button_2()
    {
        ...
        Size = new Size(177, 30);
        _TextAlignment = StringAlignment.Center;
        P1 = new Pen(Color.FromArgb(35, 47, 63));
        // P1 = Border color
    }
    ...
    protected override void OnResize(System.EventArgs e)
    {
        ...
        if (Width > 0 && Height > 0)
        {
            ...
            InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(231, 72, 86), Color.FromArgb(231, 72, 86), 90f);
            PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(231, 72, 86), Color.FromArgb(231, 72, 86), 90f);
            PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(231, 72, 86), Color.FromArgb(231, 72, 86), 90f);
...
class Ambiance_CheckBox : Control
{
    ...
    protected override void OnResize(System.EventArgs e)
    {
        if (Width > 0 && Height > 0)
        {
            ...
            GB = new LinearGradientBrush(new Rectangle(0, 0, 25, 25), Color.FromArgb(231, 72, 86), Color.FromArgb(231, 72, 86), 90);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        MyDrawer.DrawPath(new Pen(Color.FromArgb(35, 47, 63)), Shape);
        // Draw the border

        MyDrawer.DrawString(Text, Font, new SolidBrush(Color.Gainsboro), new Rectangle(17, 0, Width, Height -1), new StringFormat { LineAlignment = StringAlignment.Center });

        if (Checked)
        {
            MyDrawer.DrawString("ü", new Font("Wingdings", 12), new SolidBrush(Color.Gainsboro), new Rectangle(-2, 1, Width, Height + 2), new StringFormat { LineAlignment = StringAlignment.Center });
        }
        e.Dispose();
    }
}
...
class Ambiance_RadioButton : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (_Checked)
        {
            SolidBrush EllipseColor = new SolidBrush(Color.FromArgb(231, 72, 86));
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			...
			G.SmoothingMode = SmoothingMode.HighQuality;
			G.DrawPath(new Pen(Color.FromArgb(35, 47, 63)), PipeBorder); // Draw pipe border
			G.FillPath(new SolidBrush(Color.FromArgb(231, 72, 86)), FillValue);
...
public class Ambiance_Panel : ContainerControl
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        G.SmoothingMode = SmoothingMode.AntiAlias;
        G.FillRectangle(new SolidBrush(Color.FromArgb(35, 47, 63)), new Rectangle(0, 0, Width, Height));
        G.FillRectangle(new SolidBrush(Color.FromArgb(35, 47, 63)), new Rectangle(0, 0, Width - 1, Height - 1));
        G.DrawRectangle(new Pen(Color.Gainsboro), 0, 0, Width - 1, Height - 1);
    }
}
