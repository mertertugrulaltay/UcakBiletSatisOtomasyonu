...
namespace iTalk
{
    ...
    public class iTalk_Separator : Control
    {
        ...
        {
            base.OnPaint(e);
            e.Graphics.DrawLine(new Pen(Color.Gainsboro), 0, 5, Width, 5);
        }
    }
    ...
    class iTalk_RadioButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _G.Clear(Color.FromArgb(35, 47, 63));
            _G.SmoothingMode = SmoothingMode.AntiAlias;
            ...
            // Draw the string specified in 'Text' property
            _G.DrawString(Text, Font, new SolidBrush(Color.Gainsboro), 16, 8, new StringFormat { LineAlignment = StringAlignment.Center });
